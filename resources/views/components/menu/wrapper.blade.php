<nav 
  x-show="menu" 
  x-cloak 
  class="fixed bg-black w-full h-full sm:h-auto sm:max-w-[250px] lg:max-w-[290px] right-0 top-0 sm:top-25 md:top-35 lg:top-25 2xl:top-10 z-[120] sm:px-20 sm:pb-20 sm:pt-15 sm:!block">
